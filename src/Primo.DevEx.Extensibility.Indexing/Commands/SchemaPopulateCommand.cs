...
// Type: Sitecore.DevEx.Extensibility.Indexing.Commands.SchemaPopulateCommand
...
namespace Primo.DevEx.Extensibility.Indexing.Commands
{
  ...
  public class SchemaPopulateCommand : SubcommandBase<PopulateSchemaTask, IndexSchemaArgs>
  {
    public SchemaPopulateCommand(IServiceProvider container)
      : base("schema-populate", "Populates all managed schema", container)
    {
    ...
    protected override async Task<int> Handle(PopulateSchemaTask task, IndexSchemaArgs args)
    {
