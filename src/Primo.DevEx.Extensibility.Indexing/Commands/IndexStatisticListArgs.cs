...
// Type: Sitecore.DevEx.Extensibility.Indexing.Commands.IndexStatisticListArgs
...
namespace Primo.DevEx.Extensibility.Indexing.Commands
{
  ...
  public class IndexStatisticListArgs : IndexStatisticTaskOptions, IVerbosityArgs
  {
  }
}
